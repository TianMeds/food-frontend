...
<footer class="bg-white dark:bg-neutral-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="flex justify-between flex-wrap md:flex-nowrap">
            <div class="w-full md:w-1/4 mb-6 md:mb-0 mr-5">
                <a href="https://www.facebook.com/ReneGraceEatery" class="flex items-center mb-4">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">G & R Eatery</span>
                </a>
                <p class="text-gray-500 dark:text-gray-400">G & R Eatery, based in Makati City, has been serving high-quality local cuisine to Filipinos for over five years. We are committed to delivering delicious, authentic dishes that satisfy our customers.</p>
            </div>
            <div class="w-full md:w-1/3 mb-6 md:mb-0">
                <h6 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Quick Links</h6>
                ...
                <h6 class="mt-6 mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Location</h6>
                <p class="text-gray-500 dark:text-gray-400">515 Hizon St. Bangkal, Makati City, PH</p>
            </div>
            <div class="w-full md:w-1/3">
                <h6 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Opening Hours</h6>
                <p class="text-gray-500 dark:text-gray-400">Monday - Friday: 7:00 AM - 3:00 PM</p>
            </div>
        </div>
        <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        <div class="sm:flex sm:items-center sm:justify-center">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400 ">© 2024 <a href="https://www.facebook.com/ReneGraceEatery" class="hover:underline">G & R Eatery</a></span>
        </div>
    </div>
</footer>
